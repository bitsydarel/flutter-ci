...
then
  ...
  wget -O "$TOOLS_HOME"/android-wait-for-emulator https://raw.githubusercontent.com/bitsydarel/flutter-ci/master/scripts/wait_for_android_emulator.sh && chmod +x "$TOOLS_HOME"/wait_for_android_emulator.sh;
